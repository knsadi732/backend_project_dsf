...
const PERMISSIONS = [
  ...
  ['return.view', 'returns', 'View customer/courier returns (read-only).'],
  ['return.manage', 'returns', 'Create returns and advance their pipeline (inspection, resolution, refunds).'],
  ['marketplace_channel.view', 'finance', 'View marketplace channel cost/margin assumptions (read-only).'],
...
const ROLE_PERMISSIONS = {
  ...
  [SYSTEM_ROLES.ACCOUNTANT]: [
    ...
    'return.view',
    'return.manage',
    'marketplace_channel.view',
    'marketplace_channel.manage',
    'marketplace_settlement.view',
